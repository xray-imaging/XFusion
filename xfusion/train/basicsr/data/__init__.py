...
from xfusion.train.basicsr.data.prefetch_dataloader import PrefetchDataLoader
...
_dataset_modules = [importlib.import_module(f'xfusion.train.basicsr.data.{file_name}') for file_name in dataset_filenames]
