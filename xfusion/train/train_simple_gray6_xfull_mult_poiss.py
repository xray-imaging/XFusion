...
from xfusion.train.basicsr.data.xray_dataset_PHSH import XrayDatasetSTF, XrayVideoTestDatasetSTF
...
def create_train_val_dataloader(opt, logger):
    ...
    for phase, dataset_opt in opt['datasets'].items():
        if phase == 'train':
            ...
            #train_set = REDSDatasetSTF(dataset_opt)
            ...
            #val_set = VideoTestDatasetSTF(dataset_opt)
...
def train_pipeline(args,opt):
    ...
    opt['datasets']['val']['gt_size'] = [400,1024]
